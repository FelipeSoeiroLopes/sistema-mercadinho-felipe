<%-- 
    Document   : Processamento de Exclusão de Produto
            ...
            <%
                try {
                    ...
                    if (prodDAO.excluir(prod)){
                        out.println("<div class='success'>Produto excluído com sucesso!</div>");
                    } else {
                        out.println("<div class='error'>Não foi possível excluir o produto. Verifique se ele não está associado a vendas existentes.</div>");
                    }
                } catch (Exception ex) {
                    out.println("<div class='error'>Erro ao processar a exclusão: " + ex.getMessage() + "</div>");
                }
            %>
            <a href="index.jsp" class="back-link">&larr; Voltar para Produtos</a>
            <br>
