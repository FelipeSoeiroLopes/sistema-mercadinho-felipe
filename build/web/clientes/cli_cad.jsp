...
<%
    // Permitir cadastro de cliente para todos os funcionários logados
%>
            ...
            <%
                ...
                try {
                    ...
                    if (cliDAO.cadastrar(cli)){
                        out.println("<div class='success'>Cliente inserido com sucesso!</div>");
                        ...
                        out.println("<div class='error'>Cliente não inserido! Erro na transação.</div>");
                    }
                } catch (Exception ex) {
