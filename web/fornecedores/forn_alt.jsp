<%-- 
    Document   : Alteração de Fornecedores
            ...
            <%
                ...
                try {
                    ...
                    if (fornDAO.alterar(forn)){
                        out.println("<div class='success'>Fornecedor alterado com sucesso!</div>");
                        out.println("<div class='info'>");
                        out.println("<strong>ID: </strong>" + forn.getId() + "<br>");
                        ...
                        out.println("<div class='error'>Fornecedor não alterado! Erro na transação.</div>");
                    }
                } catch (Exception ex) {
